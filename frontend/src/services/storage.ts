...
//     localStorage.setItem(STORAGE_KEYS.TRADING_PAIRS, JSON.stringify(filteredPairs));
//   }
// };
...
//   },
//   add: (pool: LiquidityPool): void => {
//     const pools = liquidityPoolStorage.getAll();
//     pools.push(pool);
//     localStorage.setItem(STORAGE_KEYS.LIQUIDITY_POOLS, JSON.stringify(pools));
//   },
//   update: (pool: LiquidityPool): void => {
//     const pools = liquidityPoolStorage.getAll();
...
//     localStorage.setItem(STORAGE_KEYS.LIQUIDITY_POOLS, JSON.stringify(filteredPools));
//   }
// };
